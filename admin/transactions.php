    ...
    if ( $_SESSION['type'] == 2)
{
    ...
    if ($page == 'manage')
    {
      $pageTitle = 'transictions management';
      include 'init.php';
      $ord = 'ASC';
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="page-direction-bnts">
                  <ul>
                    ...
                    <li>
                      <a href="transaction.php?page=manage">
              ...
              <div class="col-md-6">
                <div class="left-header management-header">
                  ...
                  <p class="tt">total transactions <?php echo Total($conn, 'competition ') ?> transaction.</p>
                </div>
              </div>
              <div class="col-md-6">
                  ...
                  <ul>
                    <li class=" dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="transaction.php?page=manage&ordering=ASC">

                                ASC
                              </a>

                              <a class="dropdown-item" href="transaction.php?page=manage&ordering=DESC">
                                DESC
                              </a>
                            </div>
                          </li>
            ...
            <div class="default-management-list users-management">
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="left-header management-header">
                      <h1>Awards for transaction <?php echo $comp['title'] ?></h1>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="right-header management-header">
                      <div class="btns">
                        <a href="transaction.php?page=addwin&id=<?php echo $comp['id'] ?>" class="add-btn">add new Award </a>
                      </div>
                    </div>
                  </div>
                                        ...
                                        <ul>
                                          <li class=" dropdown">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <a class="dropdown-item" href="transaction.php?page=deletewin&id=<?php echo $post['id'] ?>">
      ...
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="transaction.php?page=insertwin" enctype="multipart/form-data"  id="ca-form-info"  >
      ...
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="transaction.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
                <h3>add new transaction <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
                    <div class="form-group col-12">
                      <label for="title">Descrition</label>
                      <input type="text" name="title" id="title" placeholder="exp : transiction end on this day" class="form-control">
                    </div>
                    <div class="form-group col-12">
                          ...
                          if (empty($formErrors))
                            {
                              ...
                              The awards has been successfully added
                                ...
                                <?php
                                header('location: transaction.php?page=manage');
                              }
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO transaction(title,str,ed) VALUES(:zn,:zimg, :zdesc )");
                                $stmt->execute(array(
                                  'zn' => $title,
                                  'zimg' => $str,
                                  'zdesc' => $ed
    ...
    elseif ($page == 'edit') {
      $pageTitle = "transaction edit page";
      include 'init.php';

      $id = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : header('location: transaction.php');
      $stmt = $conn->prepare("SELECT * FROM transaction WHERE id= ? LIMIT 1");
      $stmt->execute(array($id));
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="transaction.php?page=edit&id=<?php echo $postinfo['id'] ?>">
                ...
                <div class="col-md-7">
                  <div class="use-fl-info">
                    <form class="add-fomr" method="POST" action="transaction.php?page=update" enctype="multipart/form-data"  id="ca-form-info"  >
                        <div class="row">
                          <div class="form-group col-12">
    ...
    elseif ($page == 'update') {
      ...
      $id=$_POST['id'];
                            ...
                            if ($checkpst > 0 )
                            {
                                ...
                                ?>
                                  <div class="container">
                                    <a href="transaction.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
                                  </div>
                                <?php
                                ...
                                if (empty($formErrors))
                                {
                                  ...
                                  $stmt = $conn->prepare("UPDATE transaction SET name = ? ,image=?,description = ? WHERE id=? LIMIT 1  ");
     ...
     include 'init.php';
      if ($_SESSION['type'] == 2)
      {
        ...
        if ($check > 0 )
        {
          $stmt = $conn->prepare("DELETE FROM transaction WHERE id = :zid");
