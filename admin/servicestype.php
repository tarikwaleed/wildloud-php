    ...
    if ( $_SESSION['type'] == 2)
{
    $page = isset($_GET['page']) ? $_GET['page'] : 'manage';
        ...
        if ($page == 'manage')
        {
          $pageTitle = 'Ads servicestype management';
          include 'init.php';
          $ord = 'ASC';
          ...
          $stmt = $conn->prepare("SELECT * FROM servicestype  ORDER BY id $ord");
                    $stmt->execute();
                    $posts = $stmt->fetchAll();
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="page-direction-bnts">
                      <ul>
                        ...
                        <li>
                          <a href="servicestype.php?page=manage">
                  ...
                  <div class="col-md-6">
                    <div class="left-header management-header">
                      <h1>total services types</h1>
                      <p class="tt">total services types <?php echo Total($conn, 'servicestype ') ?> type.</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="right-header management-header">
                      <div class="btns">
                        <a href="servicestype.php?page=add" class="add-btn">add new service </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <ul>
                        <li class=" dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="servicestype .php?page=manage&ordering=ASC">

                                    ASC
                                  </a>

                                  <a class="dropdown-item" href="servicestype.php?page=manage&ordering=DESC">
                                    DESC
                                  </a>
                                </div>
                              </li>
                          ...
                          <tbody>
                            ...
                            foreach($posts as $post)
                            {
                              ...
                              <tr>
                                ...
                                <td>
                                  <p class="f-n"><?php echo $post['name']; ?> </p>
                                </td>
                                <?php
                                 ...
                                 ?>
                                <td>
                                  <span class="f-n" style="background:var(--mainColor);color:white;padding:8px 20px"><?php echo $sv['name']; ?> </span>
                                </td>
                                  ...
                                  <?php
                                        ...
                                        <ul>
                                          <li class=" dropdown">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    <a class="dropdown-item" href="servicestype.php?page=edit&id=<?php echo $post['id'] ?>">
                                                    <i class="fas fa-edit"></i>

                                                  edit
                                                    </a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="servicestype.php?page=delete&id=<?php echo $post['id'] ?>">
      ...
      $pageTitle = 'add new service type';
      include 'init.php';
      ?>
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="servicestype.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
                <h3>add new service type <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
        ...
        if (empty($name))
        {
          $formErrors[] = 'services type name required';
        }
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO servicestype(name,service) VALUES(:zn,:zs )");
                                $stmt->execute(array(
                                  'zn' => $name,
                                  'zs' => $service
                              ...
                              The service has been successfully added
                                ...
                                <?php
                                header('location: servicestype.php?page=manage');
                              }
    ...
    elseif ($page == 'edit') {
      $pageTitle = "servicestype edit page";
      include 'init.php';

      $id = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : header('location: servicestype.php');
      $stmt = $conn->prepare("SELECT * FROM servicestype WHERE id= ? LIMIT 1");
      ...
      if ($checkpost > 0)
      {
              ...
              <div class="row justify-content-center">
                <div class="col-md-12">
                  <div class="pg-tt" style="text-align:right">
                    <h1> edit service type - <?php echo $postinfo['name'] ?>  </h1>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="servicestype.php?page=edit&id=<?php echo $postinfo['id'] ?>">
                ...
                <div class="col-md-7">
                  <div class="use-fl-info">
                    <form class="add-fomr" method="POST" action="servicestype.php?page=update" enctype="multipart/form-data"  id="ca-form-info"  >
                        <div class="row">
                          <div class="form-group col-12">
                            <label for="name">name</label>
                          ...
                          <div class="form-group col-12">
                            ...
                            <?php
                              $stmt = $conn->prepare("SELECT *FROM services WHERE id = ?");
                              $stmt->execute(array($postinfo['service']));
                              $sv = $stmt->fetch();
                            ...
                            <select class="form-control" name="service">
                              <?php
                                ...
                                {
                                  ?>
                                  <option value="<?php echo $service['id'] ?>" <?php if($service['id'] == $sv['service'] ) { echo 'selected'; } ?> ><?php echo $service['name'] ?></option>
                                  <?php
                                }
                               ?>
                            </select>
        ...
        header('location: servicestype.php');
      }
      ?>
    ...
    elseif ($page == 'update') {
      ...
      $id=$_POST['id'];
                            ...
                            if ($checkpst > 0 )
                            {
                                ...
                                if (empty($name))
                                {
                                  $formErrors[] = 'service type name is required';
                                }
                                ...
                                ?>
                                  <div class="container">
                                    <a href="servicestype.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
                                  </div>
                                <?php
                                ...
                                if (empty($formErrors))
                                {
                                  ...
                                  $stmt = $conn->prepare("UPDATE servicestype SET name = ? ,service =?  WHERE id=? LIMIT 1  ");
                                  $stmt->execute(array($name,$service));
     ...
     include 'init.php';
      if ($_SESSION['type'] == 2)
      {
        ...
        if ($check > 0 )
        {
          $stmt = $conn->prepare("DELETE FROM servicestype WHERE id = :zid");
