<?php
  ...
  if (isset($_SESSION['admin']))
  {
    ...
    if ($page == 'manage')
    {
      $pageTitle = 'صفحة ادارة المنشورات المدونة';
      include 'init.php';
      $ord = 'ASC';
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="left-header management-header">
                  ...
                  <p class="tt">اجمالي المنشورات <?php echo Total($conn, 'posts') ?> منشور.</p>
                </div>
              </div>
                ...
                <div class="ordering">
                  <ul>
                    <li class=" dropdown">
                            ...
                            ترتيب <i class="fas fa-sort"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="posts.php?page=manage&ordering=ASC">

                                تصاعدي
                              </a>

                              <a class="dropdown-item" href="posts.php?page=manage&ordering=DESC">
                                تنازلي
                              </a>
                            </div>
                          </li>
                  ...
                  <div class="default-management-table">
                    <table class="table" id="categories-table">
                      ...
                      <tbody>
                        ...
                        foreach($posts as $post)
                        {
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              {
                                ?>
                                <span class="hidden">مخفي</span>
                                <?php
                              }else {
                                ?>
                                <span class="visible">ظاهر</span>
                                <?php
                              }
                               ?>
                        ...
                        <td>
                          <?php
                          echo  mb_strimwidth($post['content'], 0,30, "...");
                           ...
                           ?>
                            ...
                            <td>
                              <?php
                                ...
                                $user=$stmt->fetch();
                                  ?>
                                  <a style="color:rgba(0,0,0,.6);font-size:14px" href="users.php?page=edit&id=<?php echo $user['id'] ?>"><?php echo $user['fname'] ?></a>
                                  <?php
                               ?>
                            </td>
                            <td>
          ...
          <div class="row justify-content-center">
            <div class="col-md-6">
              <form class="add-fomr" method="POST" action="posts.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
                <h3>اضافة منشور <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
                    <div class="form-group col-12">
                      <label for="title">العوانت</label>
                      <input type="text" name="title" id="title" placeholder="عنوان المنشور" class="form-control">
                    </div>
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO posts(title,content,image,visibility,userid,created) VALUES(:ztitle,:zcontent,:zimg, :zvisi,:zuser,now())");
                                $stmt->execute(array(
                                  'ztitle' => $title,
                                  'zcontent' => $content,
                                  'zimg' => $image,
    ...
    elseif ($page == 'edit') {
      $pageTitle = "منفذ - صفحة تعديل المنشورات";
      include 'init.php';
              ...
              <div class="row justify-content-center">
                <div class="col-md-12">
                  <div class="pg-tt" style="text-align:right">
                    <h1> تعديل المنشور - <?php echo $postinfo['title'] ?>  </h1>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="posts.php?page=edit&id=<?php echo $postinfo['id'] ?>">

                        <?php echo $postinfo['title'] ?></a>
                      </li>
                    </ul>
                  </div>
                </div>
                    ...
                    <form class="form" method="post" action="posts.php?page=update&id=<?php echo $postinfo['id'] ?>" enctype="multipart/form-data" style="margin-bottom:60px">
                      ...
                      <div class="row">
                        <div class="col-12">
                          ...
                          <input type="text" id="title" class="form-control" name="title" placeholder="عنوان المنشور" value="<?php echo $postinfo['title'] ?>">
                        </div>
                        <div class="form-group col-12">
                          <label for="image">تحديث صورة المنشور</label>
                        ...
                        <div class="col-12">
                          <label for="visibility">الرؤية</label>
                          <select class="form-control" name="visibility">
                            <option value="0"  <?php if($postinfo['visibility'] == 0){ echo 'selected';} ?>>مخفي</option>
                            <option value="1" <?php if($postinfo['visibility'] == 1){ echo 'selected';} ?>>ظاهر</option>
                          </select>
                        ...
                        <div class="col-6">
                          <input type="submit" class="btn btn-primary" class="form-control" value="حفظ التغييرات">
    ...
    elseif ($page == 'update') {
      ...
      $pageTitle = 'منفذ - صفحة تحديث البيانات';
      include 'init.php';
                      $id = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : header('location: posts.php');;
