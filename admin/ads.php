...
if (isset($_SESSION['admin'])) {
  ...
  if ($_SESSION['type'] == 2) {
    ...
    if ($page == 'manage') {
      ...
      $stmt = $conn->prepare("SELECT * FROM ads  ORDER BY id $ord");
      $stmt->execute();
      $posts = $stmt->fetchAll();
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="left-header management-header">
                <h1>total ads points</h1>
                <p class="tt">total points
                  <?php echo Total($conn, 'ads ') ?> ads.
                </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="right-header management-header">
                <div class="btns">
                  <!-- <a href="ads.php?page=add" class="add-btn">add new service </a> -->
                </div>
              </div>
            </div>
                ...
                <ul>
                  <li class=" dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="ads.php?page=manage&ordering=ASC">

                        ASC
                      </a>

                      <a class="dropdown-item" href="ads.php?page=manage&ordering=DESC">
                        DESC
                      </a>
                    </div>
                  </li>
                    ...
                    <tbody>
                      ...
                      foreach ($posts as $post) {
                        ...
                        <tr>
                          ...
                          ?>
                          <td>
                            <a href="users.php?page=edit&id=<?php echo $svd['id'] ?>" class="f-n">
                              <?php echo $svd['fname']; ?>
                            </a>
                          </td>
                          <td>
                            <a href="<?php echo $post['link'] ?>" target="_blank" class="f-n">Link </a>
                          </td>
                          <?php
                          $stmt = $conn->prepare("SELECT * FROM services WHERE id = ?");
                          $stmt->execute(array($post['service']));
                          $sv = $stmt->fetch();
                          ...
                          <?php
                          $stmt = $conn->prepare("SELECT * FROM servicestype WHERE id = ? ");
                          $stmt->execute(array($post['servicetype']));
                          $svs = $stmt->fetch();
                          $check = $stmt->rowCount();
                          ...
                          <td>
                            ...
                            if ($check > 0) {
                              ...
                              ?>
                              <p class="f-n">no serviceType has been added </p>
                              <?php
                            }
                            ?>
                          </td>
                            ...
                            <ul>
                              <li class=" dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  ...
                                  <a class="dropdown-item" href="ads.php?page=delete&id=<?php echo $post['id'] ?>">
      ...
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="ads.php?page=insert" enctype="multipart/form-data"
                id="ca-form-info">
                <h3>add new service <i class="fas fa-plus"></i> </h3>
                <div class="row">
                  ...
                  <div class="form-group col-12">
                    ...
                    <textarea name="description" id="content" class="form-control ckeditor"
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($formErrors)) {
          ...
          $stmt = $conn->prepare("INSERT INTO ads(name,image,description,created) VALUES(:zn,:zimg, :zdesc, now() )");
          $stmt->execute(array(
            'zn' => $name,
            'zimg' => $image,
            'zdesc' => $description
          ...
          <?php
          header('location: ads.php?page=manage');
        }
    ...
    <?php
      ...
      $pageTitle = "ads edit page";
      include 'init.php';

      $id = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : header('location: ads.php');
            ...
            <div class="row justify-content-center">
              ...
              <div class="col-md-12">
                <div class="page-direction-bnts">
                  <ul>
                    ...
                    <li>
                      <a href="ads.php?page=edit&id=<?php echo $postinfo['id'] ?>">
              ...
              <div class="col-md-7">
                <div class="use-fl-info">
                  <form class="add-fomr" method="POST" action="ads.php?page=update" enctype="multipart/form-data"
                    id="ca-form-info">
                    <div class="row">
                      <div class="form-group col-12">
                        <label for="name">name</label>
                        <input type="text" name="name" id="name" placeholder=" " value="<?php echo $postinfo['name'] ?>"
                          class="form-control">
                      </div>

                      <input type="hidden" name="id" id="id" placeholder=" " value="<?php echo $postinfo['id'] ?>"
                        class="form-control">
                      ...
                      <div class="form-group col-12">
                        <p for="description" style="display:block;text-align:right">description</p>
                        <textarea name="description" id="content" class="form-control ckeditor"
                          style="text-align:right"><?php echo $postinfo['description'] ?></textarea>
      ...
      if ($checkpst > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
          ...
          ?>
          <div class="container">
            <a href="ads.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
          </div>
          <?php
          ...
          if (empty($formErrors)) {
            ...
            $stmt = $conn->prepare("UPDATE ads SET name = ? ,image=?,description = ? WHERE id=? LIMIT 1  ");
