    ...
    if ( $_SESSION['type'] == 2)
{
    $page = isset($_GET['page']) ? $_GET['page'] : 'manage';
        ...
        if ($page == 'manage')
        {
          ...
          $stmt = $conn->prepare("SELECT * FROM rewards  ORDER BY id $ord");
                    $stmt->execute();
                    $posts = $stmt->fetchAll();
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="page-direction-bnts">
                      <ul>
                        ...
                        <li>
                          <a href="rewards.php?page=manage">
                  ...
                  <div class="col-md-6">
                    <div class="left-header management-header">
                      <h1>total rewards </h1>
                      <p class="tt">total rewards <?php echo Total($conn, 'rewards ') ?> reward.</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="right-header management-header">
                      <div class="btns">
                        <a href="rewards.php?page=add" class="add-btn">add new reward </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <ul>
                        <li class=" dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="rewards.php?page=manage&ordering=ASC">

                                    ASC
                                  </a>

                                  <a class="dropdown-item" href="rewards.php?page=manage&ordering=DESC">
                                    DESC
                                  </a>
                                </div>
                              </li>
                          ...
                          <tbody>
                            ...
                            foreach($posts as $post)
                            {
                              ...
                              <tr>
                                ...
                                <td>
                                  <p class="f-n"><?php echo $post['clicks']; ?>click </p>
                                </td>
                                <td>
                                  <?php
                                  echo $post['points'];
                                        ...
                                        <ul>
                                          <li class=" dropdown">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <a class="dropdown-item" href="rewards.php?page=delete&id=<?php echo $post['id'] ?>">
      ...
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="rewards.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
                <h3>add new reward <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
                    ...
                    <div class="form-group col-12">
                      ...
                      <input type="text" name="click" id="click" placeholder=" " class="form-control">
                    </div>
                    <div class="form-group col-12">
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
        ...
        if (empty($title))
        {
          $formErrors[] = 'title reward is requried';
        }

        if (empty($click))
        {
          $formErrors[] = 'reward clicks is required';
        }

        if (empty($points))
        {
          $formErrors[] = 'reward points is required';
        }
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO rewards(title,clicks,points,description,created)
                                VALUES(:zn,:zimg, :zdesc,:zdescc, now() )");
                                $stmt->execute(array(
                                  'zn' => $title,
                                  'zimg' => $click,
                                  'zdesc' => $points,
                              ...
                              The reward  has been successfully added
                                </div>
                                <?php
                                header('location: rewards.php?page=manage');
                              }
    ...
    elseif ($page == 'edit') {
      $pageTitle = "rewards edit page";
      include 'init.php';

      $id = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : header('location: rewards.php');
      $stmt = $conn->prepare("SELECT * FROM rewards WHERE id= ? LIMIT 1");
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="rewards.php?page=edit&id=<?php echo $postinfo['id'] ?>">
                ...
                <div class="col-md-7">
                  <div class="use-fl-info">
                    <form class="add-fomr" method="POST" action="rewards.php?page=update" enctype="multipart/form-data"  id="ca-form-info"  >
                        <div class="row">
                          <div class="form-group col-12">
    ...
    elseif ($page == 'update') {
      ...
      $id=$_POST['id'];
                            ...
                            if ($checkpst > 0 )
                            {
                                ...
                                ?>
                                  <div class="container">
                                    <a href="rewards.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
                                  </div>
                                <?php
                                ...
                                if (empty($formErrors))
                                {
                                  ...
                                  $stmt = $conn->prepare("UPDATE rewards SET name = ? ,image=?,description = ? WHERE id=? LIMIT 1  ");
     ...
     include 'init.php';
      if ($_SESSION['type'] == 2)
      {
        ...
        if ($check > 0 )
        {
          $stmt = $conn->prepare("DELETE FROM rewards WHERE id = :zid");
