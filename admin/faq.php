    ...
    if ( $_SESSION['type'] == 2)
{
    $page = isset($_GET['page']) ? $_GET['page'] : 'manage';
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="left-header management-header">
                      <h1>total faq</h1>
                      <p class="tt">total faq <?php echo Total($conn, 'faq ') ?></p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="right-header management-header">
                      <div class="btns">
                        <a href="faq.php?page=add" class="add-btn">add new faq </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <ul>
                        <li class=" dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="faq.php?page=manage&ordering=ASC">

                                    ASC
                                  </a>

                                  <a class="dropdown-item" href="faq.php?page=manage&ordering=DESC">
                                    DESC
                                  </a>
                                </div>
                              </li>
                          ...
                          <tbody>
                            ...
                            foreach($posts as $post)
                            {
                              ...
                              <tr>
                                ...
                                <td>
                                  <p class="f-n"><?php echo $post['qst']; ?> </p>
                                </td>
                                <td>
                                  <p class="f-n"><?php echo $post['ans']; ?> </p>
                                </td>
                                        ...
                                        <ul>
                                          <li class=" dropdown">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <a class="dropdown-item" href="faq.php?page=delete&id=<?php echo $post['id'] ?>">
                ...
                <h3>add new service <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
                    <div class="form-group col-12">
                      ...
                      <input type="text" name="qst" id="name" placeholder=" " class="form-control">
                    </div>
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
        ...
        if (empty($qst))
        {
          $formErrors[] = 'question is required';
        }

        if (empty($ans))
        {
          $formErrors[] = 'The answer of question is required';
        }
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO faq(qst,ans) VALUES(:zn,:zimg )");
                                $stmt->execute(array(
                                  'zn' => $qst,
                                  'zimg' => $ans
                              ...
                              The FAQ has been successfully added
                                </div>
                                <?php
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="faq.php?page=edit&id=<?php echo $postinfo['id'] ?>">
                ...
                <div class="col-md-7">
                  <div class="use-fl-info">
                    <form class="add-fomr" method="POST" action="faq.php?page=update" enctype="multipart/form-data"  id="ca-form-info"  >
                        <div class="row">
                          <div class="form-group col-12">
    ...
    elseif ($page == 'update') {
      ...
      $id=$_POST['id'];
                            ...
                            if ($checkpst > 0 )
                            {
                                ...
                                ?>
                                  <div class="container">
                                    <a href="faq.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
                                  </div>
                                <?php
                                ...
                                if (empty($formErrors))
                                {
                                  ...
                                  $stmt = $conn->prepare("UPDATE faqSET name = ? ,image=?,description = ? WHERE id=? LIMIT 1  ");
