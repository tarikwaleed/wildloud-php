    ...
    if ( $_SESSION['type'] == 2)
{
    $page = isset($_GET['page']) ? $_GET['page'] : 'manage';
        ...
        if ($page == 'manage')
        {
          $pageTitle = 'fREE Points management';
          include 'init.php';
          $ord = 'ASC';
          ...
          $stmt = $conn->prepare("SELECT * FROM freepoints  ORDER BY id $ord");
                    $stmt->execute();
                    $posts = $stmt->fetchAll();
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="page-direction-bnts">
                      <ul>
                        ...
                        <li>
                          <a href="freepoints.php?page=manage">
                  ...
                  <div class="col-md-6">
                    <div class="left-header management-header">
                      <h1>total free points </h1>
                      <p class="tt">total free points <?php echo Total($conn, 'freepoints ') ?>.</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="right-header management-header">
                      <div class="btns">
                        <a href="freepoints.php?page=add" class="add-btn">add new Free points box </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <ul>
                        <li class=" dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="freepoints.php?page=manage&ordering=ASC">

                                    ASC
                                  </a>

                                  <a class="dropdown-item" href="freepoints.php?page=manage&ordering=DESC">
                                    DESC
                                  </a>
                                </div>
                              </li>
                          ...
                          <tbody>
                            ...
                            foreach($posts as $post)
                            {
                              ...
                              <tr>
                                ...
                                <td>
                                  <a href="<?php echo $post["url"] ?> " target="_blank">view <i class="fas fa-eye"></i> </a>
                                </td>
                                <td>
                                  <?php
                                  echo $post['points'];
                                        ...
                                        <ul>
                                          <li class=" dropdown">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    ...
                                                    <a class="dropdown-item" href="freepoints.php?page=delete&id=<?php echo $post['id'] ?>">
      ...
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="freepoints.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
                <h3>add new free point box <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
                    ...
                    <div class="form-group col-12">
                      ...
                      <input type="text" name="url" id="click" placeholder=" " class="form-control">
                    </div>
                    <div class="form-group col-12">
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST')
      {
        ...
        if (empty($title))
        {
          $formErrors[] = 'title  is requried';
        }

        if (empty($url))
        {
          $formErrors[] = 'url is required';
        }
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO freepoints(title,url,points,created)
                              ...
                              The free points  has been successfully added
                                </div>
                                <?php
                                header('location: freepoints.php?page=manage');
                              }
    ...
    elseif ($page == 'edit') {
      $pageTitle = "freepoints edit page";
      include 'init.php';

      $id = isset($_GET['id']) && is_numeric($_GET['id']) ? intval($_GET['id']) : header('location: freepoints.php');
      $stmt = $conn->prepare("SELECT * FROM freepoints WHERE id= ? LIMIT 1");
      ...
      if ($checkpost > 0)
      {
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="freepoints.php?page=edit&id=<?php echo $postinfo['id'] ?>">
                ...
                <div class="col-md-7">
                  <div class="use-fl-info">
                    <form class="add-fomr" method="POST" action="freepoints.php?page=update" enctype="multipart/form-data"  id="ca-form-info"  >
                        <div class="row">
                          <div class="form-group col-12">
        ...
        header('location: freepoints.php');
      }
      ?>
    ...
    elseif ($page == 'update') {
      ...
      $id=$_POST['id'];
                            ...
                            if ($checkpst > 0 )
                            {
                                ...
                                ?>
                                  <div class="container">
                                    <a href="freepoints.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
                                  </div>
                                <?php
                                ...
                                if (empty($formErrors))
                                {
                                  ...
                                  $stmt = $conn->prepare("UPDATE freepoints SET name = ? ,image=?,description = ? WHERE id=? LIMIT 1  ");
     ...
     include 'init.php';
      if ($_SESSION['type'] == 2)
      {
        ...
        if ($check > 0 )
        {
          $stmt = $conn->prepare("DELETE FROM freepoints WHERE id = :zid");
