    ...
    if ( $_SESSION['type'] == 2)
{
    $page = isset($_GET['page']) ? $_GET['page'] : 'manage';
        ...
        if ($page == 'manage')
        {
          $pageTitle = 'Ads services management';
          include 'init.php';
          $ord = 'ASC';
          ...
          $stmt = $conn->prepare("SELECT * FROM services  ORDER BY id $ord");
                    $stmt->execute();
                    $posts = $stmt->fetchAll();
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="page-direction-bnts">
                      <ul>
                        ...
                        <li>
                          <a href="services.php?page=manage">
                  ...
                  <div class="col-md-6">
                    <div class="left-header management-header">
                      ...
                      <p class="tt">total services <?php echo Total($conn, 'services ') ?> service.</p>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="right-header management-header">
                      <div class="btns">
                        <a href="services.php?page=add" class="add-btn">add new service </a>
                      </div>
                    </div>
                  </div>
                      ...
                      <ul>
                        <li class=" dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                  <a class="dropdown-item" href="services .php?page=manage&ordering=ASC">

                                    ASC
                                  </a>

                                  <a class="dropdown-item" href="services.php?page=manage&ordering=DESC">
                                    DESC
                                  </a>
                                </div>
                              </li>
                          ...
                          <tbody>
                            ...
                            foreach($posts as $post)
                            {
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="avatar">
                                    <?php
                                        ...
                                        {
                                          ?>
                                          <img src="<?php echo $images  ?>default.png" alt="avart" style="width:40px">
                                        ...
                                        {
                                          ?>
                                          <img src="<?php echo $images . $post['image']  ?>" alt="avart" style="width:40px">
                                ...
                                <td>
                                  <p class="f-n"><?php echo $post['description']; ?> </p>
                                </td>
                                <td>
                                  <?php
                                  echo $post['created'];
                                  ...
                                  <?php
                                        ...
                                        <ul>
                                          <li class=" dropdown">
                                                  ...
                                                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                    <a class="dropdown-item" href="services.php?page=edit&id=<?php echo $post['id'] ?>">
                                                    <i class="fas fa-edit"></i>

                                                  edit
                                                    </a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item" href="services.php?page=delete&id=<?php echo $post['id'] ?>">
      ...
      <div class="add-default-page add-post-page  add-product-page " id="add-page">
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <form class="add-fomr" method="POST" action="services.php?page=insert" enctype="multipart/form-data"  id="ca-form-info"  >
                <h3>add new service <i class="fas fa-plus"></i>  </h3>
                  <div class="row">
                    ...
                    <div class="form-group col-12">
                      ...
                      <textarea name="description" id="content"  class="form-control ckeditor"style="text-align:right" ></textarea>
                          ...
                          if (empty($formErrors))
                            {
                                ...
                                $stmt = $conn->prepare("INSERT INTO services(name,image,description,created) VALUES(:zn,:zimg, :zdesc, now() )");
                                $stmt->execute(array(
                                  'zn' => $name,
                                  'zimg' => $image,
                                  'zdesc' => $description
                              ...
                              The service has been successfully added
                                ...
                                <?php
                                header('location: services.php?page=manage');
                              }
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-12">
                  <div class="page-direction-bnts">
                    <ul>
                      ...
                      <li>
                        <a href="services.php?page=edit&id=<?php echo $postinfo['id'] ?>">
                ...
                <div class="col-md-7">
                  <div class="use-fl-info">
                    <form class="add-fomr" method="POST" action="services.php?page=update" enctype="multipart/form-data"  id="ca-form-info"  >
                        <div class="row">
                          <div class="form-group col-12">
                            <label for="name">name</label>
    ...
    elseif ($page == 'update') {
      ...
      $id=$_POST['id'];
                            ...
                            if ($checkpst > 0 )
                            {
                                ...
                                ?>
                                  <div class="container">
                                    <a href="services.php?page=edit&id=<?php echo $id ?>">click here to back to latest page</a>
                                  </div>
                                <?php
                                ...
                                if (empty($formErrors))
                                {
                                  ...
                                  $stmt = $conn->prepare("UPDATE services SET name = ? ,image=?,description = ? WHERE id=? LIMIT 1  ");
     ...
     include 'init.php';
      if ($_SESSION['type'] == 2)
      {
        ...
        if ($check > 0 )
        {
          $stmt = $conn->prepare("DELETE FROM services WHERE id = :zid");
